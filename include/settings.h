...
constexpr bool PRESENCE_BLE_DEFAULT_ENABLED = false;///< Presence auto-off default state
constexpr uint32_t PRESENCE_BLE_GRACE_MS_DEFAULT = 3000; ///< Wait before presence-off triggers
