...
export function LightMusicCard({ onLightToggle, onLightGain, onLightCalib, onMusicToggle, onMusicGain, onClapThr, onClapCool }: Props) {
  return (
    <Card>
      <CardHeader>
        <CardTitle><Trans k="title.lightmusic">Light &amp; Music</Trans></CardTitle>
      </CardHeader>
