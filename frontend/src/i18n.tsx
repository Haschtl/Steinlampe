...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "title.btSleep": "BT-Serial Sleep",
    "desc.btSleep": "Turn off Classic BT after a timeout (0 = disabled). BLE stays active.",
    "label.btSleepBoot": "After boot (min)",
    "label.btSleepBle": "After last BLE cmd (min)",
  ...
  de: {
    ...
    "title.btSleep": "BT-Serial Sleep",
    "desc.btSleep": "Classic BT nach einem Timeout ausschalten (0 = aus). BLE bleibt aktiv.",
    "label.btSleepBoot": "Nach Boot (Min)",
    "label.btSleepBle": "Nach letzter BLE-Cmd (Min)",
    "label.bleName": "BLE-Name",
    "label.btName": "BT-Name",
