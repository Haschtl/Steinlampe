...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "desc.tapSwitch": "Tap the physical switch to cycle through selected quick modes.",
    ...
    "help.bleMidiNote": "Standard BLE-MIDI UUIDs; enable with the optional BLE-MIDI flag. Write/WriteNR RX-only.",
  ...
  de: {
    ...
    "desc.tapSwitch": "Mit dem physischen Schalter durch die Quick-Modes blättern.",
    ...
    "help.bleMidiNote": "Standard BLE-MIDI UUIDs; per optionalem Flag aktivieren. Write/WriteNR, nur RX.",
